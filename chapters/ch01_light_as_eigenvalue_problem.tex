...
happens when the operator loses its self-adjoint character.zazazazazazaza
\end{chapterlead}
...
\begin{align}
qaqaqaqaqaqaqaqaqaqaq \curl \EE(\rr,t) &= -\pdv{\BB(\rr,t)}{t}, \label{eq:faraday}\\[4pt]
 \curl \HH(\rr,t) &= \phantom{-}\pdaqaqaqaqaq}, \label{eq:ampere}\\[4pt]
 \divg \DD(\rr,t) &= 0, \label{eq:gauss-e}\\[4pt]
 \divg \BB(\rr,t) &= 0. \label{eq:gauss-m}
\end{align}
These four equations, supplemaqaqaqaqaqaqaqaqaqaqaqaelations connecting
$\DD$ to $\EE$ and $\BB$ to $\HH$, form the complete classical description of
electromagnetic fields in matter. Nothing in this bqaqaqaqaqaqaqaqaqaqructure we shall develop is
