...
\begin{chapterlead}
What does it mean, physically, to say that light has ``modes''? Every physicist who has
...
happens when the operator loses its self-adjoint character.
\end{chapterlead}
